...
```sh
  cd my-folder
  git clone  https://github.com/paulinagonzalezc/hello-react-front-end
```
...
Feel free to check the [issues page](https://github.com/paulinagonzalezc/hello-react-front-end/issues).
